...
function stringifyOne(format: FormatId, graph: Graph, options: StringifyOptions): string {
  ...
  switch (format) {
    ...
    case 'yarn-berry-v4': return yarnBerryV4.stringify(graph, { lineEnding, cacheKey, onDiagnostic, overrides })
    case 'yarn-berry-v5': return yarnBerryV5.stringify(graph, { lineEnding, cacheKey, onDiagnostic, overrides })
    case 'yarn-berry-v6': return yarnBerryV6.stringify(graph, { lineEnding, cacheKey, onDiagnostic, overrides })
    case 'yarn-berry-v7': return yarnBerryV7.stringify(graph, { lineEnding, cacheKey, onDiagnostic, overrides })
    case 'yarn-berry-v8':  return yarnBerryV8.stringify(graph,  { lineEnding, cacheKey, onDiagnostic, overrides })
    case 'yarn-berry-v9':  return yarnBerryV9.stringify(graph,  { lineEnding, cacheKey, onDiagnostic, overrides })
    case 'yarn-berry-v10': return yarnBerryV10.stringify(graph, { lineEnding, cacheKey, onDiagnostic, overrides })
    case 'yarn-classic':   return yarnClassic.stringify(graph,  { lineEnding, onDiagnostic, overrides })
